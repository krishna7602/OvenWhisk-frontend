...
const SummaryApi = {
    ...
    ,
    findAllCategoryCategory : {
        url : `${backendDomin}/api/findAllCategoryCategory/`,
        method : "post"
    }
    ,
    findAllSubCategoryCategory : {
        url : `${backendDomin}/api/findAllSubCategoryCategory/`,
        method : "post"
    }
    ,
    findSubcategoriesByCategory : {
        url : `${backendDomin}/api/findSubcategoriesByCategory/`,
        method : "post"
    }
    ,
    orderGetAll : {
